...
packets = {
    ...
    22: Struct("collect item",
               UBInt32("collected_eid"),
               UBInt32("collector_eid"),
               ),
    ...
    209: Struct("teams",
                ...
                SBInt8("mode"),
                If(lambda context: context["mode"] == 0 or context["mode"] == 2,
                ...
                If(lambda context: context["mode"] == 0 or context["mode"] == 3 or context["mode"] == 4,
                   Embed(Struct("players",
                                SBInt16("player_count"),
                                MetaArray(lambda ctx: ctx.player_count, AlphaString("names")),
                                )
                         )
                   ),
                ),
